...
class _$_GiftAsk implements _GiftAsk {
  ...
  @override
  String toString() {
    return 'GiftAsk(id: $id, giftAskStatus: $giftAskStatus, requester: $requester, address: $address, area: $area, position: $position, reuqestDate: $reuqestDate, requestForNoOfPeople: $requestForNoOfPeople, prescriptionImageUrl: $prescriptionImageUrl, giftAskType: $giftAskType, giftTitle: $giftTitle, giftForSmallFamily: $giftForSmallFamily, note: $note, createdAt: $createdAt)';
  }
