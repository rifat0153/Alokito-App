...
/// @nodoc
abstract class $MyResponseCopyWith<T, $Res> {
  factory $MyResponseCopyWith(
          MyResponse<T> value, $Res Function(MyResponse<T>) then) =
      _$MyResponseCopyWithImpl<T, $Res>;
}

/// @nodoc
class _$MyResponseCopyWithImpl<T, $Res>
    implements $MyResponseCopyWith<T, $Res> {
  _$MyResponseCopyWithImpl(this._value, this._then);

  final MyResponse<T> _value;
  // ignore: unused_field
  final $Res Function(MyResponse<T>) _then;
}
...
/// @nodoc
class _$DataCopyWithImpl<T, $Res> extends _$MyResponseCopyWithImpl<T, $Res>
...
class _$Data<T> implements Data<T> {
  ...
  @override
  String toString() {
    return 'MyResponse<$T>.data(data: $data)';
  }
...
abstract class Data<T> implements MyResponse<T> {
...
/// @nodoc
class _$LoadingCopyWithImpl<T, $Res> extends _$MyResponseCopyWithImpl<T, $Res>
...
abstract class Loading<T> implements MyResponse<T> {
...
/// @nodoc
class _$ErrorCopyWithImpl<T, $Res> extends _$MyResponseCopyWithImpl<T, $Res>
...
class _$Error<T> implements Error<T> {
  ...
  @override
  String toString() {
    return 'MyResponse<$T>.error(error: $error)';
  }
...
abstract class Error<T> implements MyResponse<T> {
  const factory Error(Object error) = _$Error<T>;
